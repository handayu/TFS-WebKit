...
namespace USeFuturesSpirit
{
    ...
    public class FrontSeverConfigViewModel : USeBaseViewModel
    {
        ...
        private string m_userProductInfo;
        ...
        {
            get { return m_userProductInfo; }
            set
            {
                if (value != m_userProductInfo)
                {
                    m_userProductInfo = value;
                    SetProperty(() => this.UserProductInfo);
                }
            }
        }
        ...
        public static FrontSeverConfigViewModel Create(FrontSeverConfig data)
        {
            ...
            model.AuthCode = data.AuthCode;
            model.UserProductInfo = data.UserProductInfo;
            return model;
        }
    }
}
