...
# if DEBUG
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                LoginAccount loginAccount = new LoginAccount() {
                    ...
                    AuthCode = serverConfig.AuthCode,
                    UserProductInfo = serverConfig.UserProductInfo
                };
        ...
        private void LoginWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            //信息认证
            if(loginAccount.AuthCode != null && loginAccount.UserProductInfo != null
                && loginAccount.AuthCode != "" && loginAccount.UserProductInfo != "")
            {
                m_orderDriver.AuthorT(loginAccount.BrokerId, loginAccount.Account, "W3RL359BLRY5S3OK", "QH10802800");
            }
            //登陆
