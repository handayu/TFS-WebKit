...
namespace USeFuturesSpirit
{
    public partial class MainForm : Form
    {
        ...
        /// <param name="e"></param>
        private void QuerySettlementToolStripMenuItem_Click(object sender, EventArgs e)
        {
            QuerySettlementInfoForm form = new QuerySettlementInfoForm(USeManager.Instance.OrderDriver);
            form.ShowDialog();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void QualityAlalisyToolStripMenuItem_Click(object sender, EventArgs e)
        {
            QualityAlalisyForm form = new QualityAlalisyForm(USeManager.Instance.OrderDriver);
            form.ShowDialog();
        }
    }
}
