...
namespace USe.CTPApi
{
    ...
    public class TradeApi
    {
        ...
        /// <param name="_broker">经纪公司代码:2030-CTP模拟/上期-4030/申万-4070</param>
        /// <param name="_addr">前置地址:默认为CTP模拟</param>
        public TradeApi(string _investor, string _pwd, string _broker = "4200"
            , string _addr = "tcp://180.166.11.33:41205")
        {
