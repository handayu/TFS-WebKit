...
namespace USe.Common.DBDriver
{
    ...
    /// Access数据库SQL语句生成类。
    /// </summary>
    public class AccessSqlCreator :DBSqlCreator
    {
        /// <summary>
        /// 创建者名称。
        /// </summary>
        ...
        public override string CreateUpdateSql(string dbName, string tableName, List<DBField> updateFields, List<DBField> keyFields)
        {
            ...
            for (int i = 0; i < updateFields.Count; i++)
            {
                ...
                updateStr.Append(string.Format("[{0}] = {1},", field.FieldName, field.ValueString));
            }
            ...
            for (int i = 0; i < keyFields.Count; i++)
            {
                ...
                keyStr.Append(string.Format("[{0}] = {1} and ", field.FieldName, field.ValueString));
            }
