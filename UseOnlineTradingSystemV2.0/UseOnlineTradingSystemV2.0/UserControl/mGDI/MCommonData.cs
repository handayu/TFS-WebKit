    ...
    public class MCommonData
    {
        ...
        public static Bitmap Black
        {
            get
            {
                if (black == null)
                {
                    black = new Bitmap(Resources.icon_black.Width / 2, Resources.icon_black.Height / 2);
                    Graphics g = Graphics.FromImage(black);
                    g.DrawImage(Resources.icon_black, 0, 0, Resources.icon_black.Width / 2, Resources.icon_black.Height / 2);
                }
                return black;
            }
        }

        private static Bitmap publish;
        /// <summary>
        /// 发布者图片
        /// </summary>
        public static Bitmap Publish
        {
            get
            {
                if (publish == null)
                {
                    publish = new Bitmap(Resources.icon_publish.Width / 2, Resources.icon_publish.Height / 2);
                    Graphics g = Graphics.FromImage(publish);
                    g.DrawImage(Resources.icon_publish, 0, 0, Resources.icon_publish.Width / 2, Resources.icon_publish.Height / 2);
                }
                return publish;
            }
        }
        ...
        public static Bitmap White
        {
            get
            {
                if (white == null)
                {
                    white = new Bitmap(Resources.icon_white.Width / 2, Resources.icon_white.Height / 2);
                    Graphics g = Graphics.FromImage(white);
                    g.DrawImage(Resources.icon_white, 0, 0, Resources.icon_white.Width / 2, Resources.icon_white.Height / 2);
                }
                return white;
            }
        }
